const branches=[
  {id:'pickup',name:'Предзаказ с собой',time:'08:00-22:00',address:'забрать кофе и еду без ожидания'},
  {id:'dinein',name:'Заказ в зале',time:'08:00-22:00',address:'заказ для гостей внутри Focus'},
  {id:'booking',name:'Бронь столика',time:'10:00-22:00',address:'бронь стола под завтрак, обед или ужин'}
];
const products=[
  {id:'flatwhite',cat:'coffee',icon:'☕',name:'Флэт уайт',desc:'двойной эспрессо, мягкое молоко, чистый вкус',price:180,tone:'#d8ff68'},
  {id:'americano',cat:'coffee',icon:'●',name:'Чёрный американо',desc:'чистый кофе, быстро и без лишнего',price:130,tone:'#eeeeee'},
  {id:'latte',cat:'coffee',icon:'◐',name:'Айс латте',desc:'эспрессо, молоко, лёд, лёгкая текстура',price:190,tone:'#c8c1b2'},
  {id:'filter',cat:'coffee',icon:'◎',name:'Фильтр дня',desc:'мягкий профиль, удобно брать с собой',price:160,tone:'#d8ff68'},
  {id:'toast',cat:'kitchen',icon:'▣',name:'Авокадо-тост',desc:'хлеб, авокадо, яйцо, зелень',price:290,tone:'#b7ff2a'},
  {id:'breakfast',cat:'kitchen',icon:'◒',name:'Фокус-завтрак',desc:'яйца, салат, тост, соус, сезонные добавки',price:340,tone:'#f3f1ec'},
  {id:'shakshuka',cat:'kitchen',icon:'◉',name:'Шакшука',desc:'томаты, яйца, специи, хлеб',price:320,tone:'#ffb36b'},
  {id:'sandwich',cat:'kitchen',icon:'▰',name:'Сэндвич с курицей',desc:'курица, соус, зелень, хрустящий хлеб',price:310,tone:'#d5c3a3'},
  {id:'salad',cat:'kitchen',icon:'◇',name:'Зелёный боул',desc:'овощи, зелень, яйцо, лёгкий соус',price:280,tone:'#a8ff35'},
  {id:'croissant',cat:'dessert',icon:'△',name:'Круассан',desc:'тёплый круассан к утреннему кофе',price:110,tone:'#d5c3a3'},
  {id:'bun',cat:'dessert',icon:'◇',name:'Булочка с кардамоном',desc:'ароматная булочка к кофе',price:120,tone:'#c9b48f'},
  {id:'cheesecake',cat:'dessert',icon:'□',name:'Баскский чизкейк',desc:'нежный десерт к фильтру или латте',price:190,tone:'#8c8174'}
];
const cats=[['all','Все'],['coffee','Кофе'],['kitchen','Кухня'],['dessert','Десерты']];
const seed=[
  ...
  {id:'demo4',name:'Гость Focus',avatar:'F',cups:9,orders:3,totalSpent:2080}
];
...
function publicName(v=''){let s=String(v).replaceAll('@','').replaceAll('+','').replace(/[0-9]/g,'').replace(/\s+/g,' ').trim();return s.length>1?s.slice(0,22):'Гость Focus'}
